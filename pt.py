...
import models
import numpy as np
from traintest_pavmae import train
...
if args.model == 'pavmae':
    audio_model = models.PAVMAE(audio_length=args.target_length, norm_pix_loss=args.norm_pix_loss, modality_specific_depth=11, tr_pos=args.tr_pos)
else:
